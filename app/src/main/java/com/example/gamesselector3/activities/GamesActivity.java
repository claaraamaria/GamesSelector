...
public abstract class GamesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAppAdapter = new MyAppAdapter(images, GamesActivity.this);
    ...
    public class MyAppAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            RequestBuilder<Drawable> drawableRequestBuilder = Glide.with(GamesActivity.this).load(parkingList.get(position).getImagePath());
