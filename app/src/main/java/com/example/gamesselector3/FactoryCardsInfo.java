...
public class FactoryCardsInfo {
    public static List<Data> getCardsInfo(GameType cardType) {
        ...
        switch (cardType) {
            case BOARD_GAMES:
                dataList.add(new Data("board_game", "For this kind of games, a link with the complete rules will be listed."));
                dataList.add(new Data("Football (Soccer)", "Catan\n"));
                dataList.add(new Data("board_game", "Dixit \n"));
                dataList.add(new Data("drinking_games", "Cards against humanity \n"));
                break;

            case CARD_GAMES:
                dataList.add(new Data("Football (Soccer)", "SlapJack\n" +
                ...
                dataList.add(new Data("board_game", "Crazy Eights \n" +
                ...
                dataList.add(new Data("drinking_games", "Play or pay \n" +
            ...
            case BALL_GAMES:
                dataList.add(new Data("Football (Soccer)", "Football (Soccer)\n" +
                ...
                dataList.add(new Data("board_game", "Basketball \n" +
                ...
                dataList.add(new Data("drinking_games", "Handball \n" +
                ...
                dataList.add(new Data("ball_games", "Footballtennis (futnet) \n" +
            ...
            case DRINKING_GAMES:
                ...
                dataList.add(new Data("drinking_games", "Straight Face \n" +
                ...
                dataList.add(new Data("ball_games", "Buzz \n" +
            ...
            case INTERACTIVE_GAMES:
                dataList.add(new Data("Football (Soccer)", "Hide and seek\n" +
                ...
                dataList.add(new Data("board_game", "Dodgeball \n" +
                ...
                dataList.add(new Data("drinking_games", "Tag \n" +
                        "Number of Players: 7 players on each side, six outfield players and one goalkeeper. \n" +
