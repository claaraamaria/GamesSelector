...
public class FactoryCardsInfo {
    public static List<CardImagesData> getCardsInfo(GameType cardType) {
        List<CardImagesData> dataList = new ArrayList<>();
        switch (cardType) {
            case BALL_GAMES:
                dataList.add(new CardImagesData(R.drawable.ball_games, "Football (Soccer)\n" +
                ...
                dataList.add(new CardImagesData(R.drawable.ball_games, "Basketball \n" +
                ...
                dataList.add(new CardImagesData(R.drawable.ball_games, "Handball \n" +
                ...
                dataList.add(new CardImagesData(R.drawable.ball_games, "Footballtennis (futnet) \n" +
            ...
            case BOARD_GAMES:
                dataList.add(new CardImagesData(R.drawable.board_game, "For this kind of games, a link with the complete rules will be listed."));
                dataList.add(new CardImagesData(R.drawable.board_game, "Catan\n"));
                dataList.add(new CardImagesData(R.drawable.board_game, "Dixit \n"));
                dataList.add(new CardImagesData(R.drawable.board_game, "Cards against humanity \n"));
                break;

            case DRINKING_GAMES:
                dataList.add(new CardImagesData(R.drawable.drinking_games, "Please drink responsibly \n" +
                        "This kind of games do not have time or number of persons required."));
                dataList.add(new CardImagesData(R.drawable.drinking_games, "Never Have I Ever\n" +
                        "Rules: You have to share something that you have never done before and the people who have will take a sip of their drink."));
                dataList.add(new CardImagesData(R.drawable.drinking_games, "Thumper \n" +
                ...
                dataList.add(new CardImagesData(R.drawable.drinking_games, "Straight Face \n" +
                ...
                dataList.add(new CardImagesData(R.drawable.drinking_games, "Buzz \n" +
            ...
            case CARD_GAMES:
                dataList.add(new CardImagesData(R.drawable.deck_of_cards, "SlapJack\n" +
                ...
                dataList.add(new CardImagesData(R.drawable.deck_of_cards, "Crazy Eights \n" +
                ...
                dataList.add(new CardImagesData(R.drawable.deck_of_cards, "Play or pay \n" +
            ...
            case INTERACTIVE_GAMES:
                dataList.add(new CardImagesData(R.drawable.hide_and_seek, "Hide and seek\n" +
                ...
                dataList.add(new CardImagesData(R.drawable.hide_and_seek, "Dodgeball \n" +
                ...
                dataList.add(new CardImagesData(R.drawable.hide_and_seek, "Tag \n" +
                        "Number of Players: 7 players on each side, six outfield players and one goalkeeper. \n" +
